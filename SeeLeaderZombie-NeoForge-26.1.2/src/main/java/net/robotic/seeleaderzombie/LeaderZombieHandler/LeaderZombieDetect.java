...
public class LeaderZombieDetect {
    ...
    private static final String eName = "Leader Zombie"; // eName stands for entityName
    ...
    public void onServerStarting(ServerStartingEvent event) {
        ...
        if ((VERSION.equals("26.1") || VERSION.equals("26.1.2") || VERSION.equals("26.2")) && Config.healLeader) {
